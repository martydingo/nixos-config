{ pkgs, ... }: {
  services.udev = {
    ...
    extraRules = ''
      ...
      #---------------------------------------------------------------#
      ACTION=="add", SUBSYSTEM=="platform", KERNEL=="faustus", RUN+="/nix/store/6wgd8c9vq93mqxzc7jhkl86mv6qbc360-coreutils-9.5/bin/chmod a+w /sys/bus/platform/devices/%k/kbbl/kbbl_blue"
      ACTION=="add", SUBSYSTEM=="platform", KERNEL=="faustus", RUN+="/nix/store/6wgd8c9vq93mqxzc7jhkl86mv6qbc360-coreutils-9.5/bin/chmod a+w /sys/bus/platform/devices/%k/kbbl/kbbl_flags"
      ACTION=="add", SUBSYSTEM=="platform", KERNEL=="faustus", RUN+="/nix/store/6wgd8c9vq93mqxzc7jhkl86mv6qbc360-coreutils-9.5/bin/chmod a+w /sys/bus/platform/devices/%k/kbbl/kbbl_green"
      ACTION=="add", SUBSYSTEM=="platform", KERNEL=="faustus", RUN+="/nix/store/6wgd8c9vq93mqxzc7jhkl86mv6qbc360-coreutils-9.5/bin/chmod a+w /sys/bus/platform/devices/%k/kbbl/kbbl_mode"
      ACTION=="add", SUBSYSTEM=="platform", KERNEL=="faustus", RUN+="/nix/store/6wgd8c9vq93mqxzc7jhkl86mv6qbc360-coreutils-9.5/bin/chmod a+w /sys/bus/platform/devices/%k/kbbl/kbbl_red"
      ACTION=="add", SUBSYSTEM=="platform", KERNEL=="faustus", RUN+="/nix/store/6wgd8c9vq93mqxzc7jhkl86mv6qbc360-coreutils-9.5/bin/chmod a+w /sys/bus/platform/devices/%k/kbbl/kbbl_set"
      ACTION=="add", SUBSYSTEM=="platform", KERNEL=="faustus", RUN+="/nix/store/6wgd8c9vq93mqxzc7jhkl86mv6qbc360-coreutils-9.5/bin/chmod a+w /sys/bus/platform/devices/%k/kbbl/kbbl_speed"

      #---------------------------------------------------------------#
      #  ASUS TUF Laptops (asus-wmi)                                  #
      #---------------------------------------------------------------#
      ACTION=="add", SUBSYSTEM=="leds", KERNEL=="asus::kbd_backlight", RUN+="/nix/store/6wgd8c9vq93mqxzc7jhkl86mv6qbc360-coreutils-9.5/bin/chmod a+w /sys%p/kbd_rgb_mode"
      ACTION=="add", SUBSYSTEM=="leds", KERNEL=="asus::kbd_backlight", RUN+="/nix/store/6wgd8c9vq93mqxzc7jhkl86mv6qbc360-coreutils-9.5/bin/chmod a+w /sys%p/brightness"
