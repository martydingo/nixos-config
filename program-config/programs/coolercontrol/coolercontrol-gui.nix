{ lib, rustPlatform, dbus, freetype, gtk3, libsoup_3, openssl, pkg-config
, webkitgtk_4_1, libappindicator, makeWrapper, coolercontrol, }:
...
rustPlatform.buildRustPackage {
  ...
  buildInputs =
    [ dbus openssl freetype libsoup_3 gtk3 webkitgtk_4_1 libappindicator ];
