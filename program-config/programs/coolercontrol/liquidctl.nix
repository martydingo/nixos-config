...
, setuptools, setuptools-scm, wheel, docopt, hidapi, pyusb, smbus-cffi
, i2c-tools, pytestCheckHook, colorlog, crcmod, pillow, fetchpatch, }:
...
buildPythonPackage rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = pname;
    rev = "${version}";
    hash = "sha256-E44HQonOsOYyEemkum5Ye5jj6k+4UeH3SnEIKHJKwjA=";
  };

  nativeBuildInputs = [ installShellFiles setuptools setuptools-scm wheel ];
